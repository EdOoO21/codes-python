...
async def test_multiple_blocking_detection(
    ...
    stats = await main(duration=duration, num_tasks=num_tasks, blocking_chance=blocking_chance, max_blocking_time=max_blocking_time, min_blocking_time=min_blocking_time, max_non_blocking_time=max_non_blocking_time, min_non_blocking_time=min_non_blocking_time)
